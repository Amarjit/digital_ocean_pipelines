...
cp setup/webhook/webhook.php /var/www/$DOMAIN/deploy/artifacts/public/webhook.php
chown www-data:www-data /var/www/$DOMAIN/deploy/artifacts/public/webhook.php
chmod 400 /var/www/$DOMAIN/deploy/artifacts/public/webhook.php # read-only
